        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#"><?php if(isset($_SESSION['name'])){ echo $_SESSION['name'];} else{ echo "Welcome";} ?> <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
          ...
          <form class="form-inline my-2 my-lg-0">
            ...
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><?php echo date("l jS \of F Y h:i:s A" );?></button>
          </form>
        </div>
      </nav>
